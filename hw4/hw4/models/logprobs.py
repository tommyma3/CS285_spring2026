...
def compute_per_token_logprobs(
    ...
    *,
    ...
    return -nll.reshape(input_ids.shape[0], input_ids.shape[1] - 1)
...
def build_completion_mask(
    ...
    mask = torch.zeros(input_ids.shape[0], input_ids.shape[1] - 1, device=input_ids.device, dtype=torch.float)
